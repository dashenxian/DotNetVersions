...
namespace DotNetVersions
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            //DotNet Core
            var str = XSX.Helper.CmdHelper.RunCmdAndGetOutput("dotnet --list-sdks",out bool isExitCodeSuccessful);
            if (isExitCodeSuccessful)
            {
                Console.WriteLine("Currently installed .NET Versions in the system:");
